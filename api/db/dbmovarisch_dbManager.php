...
function getConnection() {
	...
	global $db_movarisch_db_Url, $db_movarisch_db_User, $db_movarisch_db_Pass, $db_movarisch_db_DbName;
	
	try {
		$dbh = new PDO("mysql:host=".$db_movarisch_db_Url.";dbname=".$db_movarisch_db_DbName, $db_movarisch_db_User, $db_movarisch_db_Pass);
